...
class QuantizableInvertedResidual(InvertedResidual):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(  # type: ignore[misc]
            se_layer=QuantizableSqueezeExcitation, *args, **kwargs
        )
...
def _load_weights(
    arch: str, model: QuantizableMobileNetV3, model_url: Optional[str], progress: bool
) -> None:
...
def _mobilenet_v3_model(
    ...
    **kwargs: Any,
    ...
    if quantize:
        ...
        if pretrained:
            _load_weights(
                arch, model, quant_model_urls.get(arch + "_" + backend, None), progress
            )
